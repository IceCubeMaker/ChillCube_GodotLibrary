...
# The Y height of the horizontal dragging plane
# (usually the object's height when drag started)
@export var drag_height := 0.0

# Offset between mouse hit point and object's center
# Prevents snapping the object to cursor center
